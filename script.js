...
(function initializeUI() {
    console.log("⚡ NRX Mining Platform - Value-Preserving Mining");
    console.log("💰 Daily Limit: 20 NRX | Mining Rate: 0.00139 NRX/sec");
    console.log("⏱️  5-min Session: 0.417 NRX | Full Daily: 48 sessions (4 hours)");
...
function loadLocalProgress() {
    try {
        ...
        if (saved) {
            ...
            console.log("📦 Loaded progress:", minedTokens.toFixed(4), "NRX");
        }
    } catch (error) {
...
function startMiningWithTimer() {
    ...
    // ✅ START VALUE-PRESERVING MINING
    startActualMining();
    
    // Start 5-minute countdown
    startCountdownTimer();
    
    console.log('⛏️ Mining ACTIVE! Rate:', (miningSpeed / 20 * MINING_RATE).toFixed(6), 'NRX/sec');
    console.log('📈 Expected this session: 0.417 NRX');
}
...
function startActualMining() {
    ...
    // ✅ VALUE-PRESERVING MINING RATE: 0.00139 NRX/sec at 20 H/s
...
function startCountdownTimer() {
    ...
    miningTimer = setInterval(() => {
        ...
        if (miningTimeLeft <= 0) {
            ...
            console.log('📊 Tokens mined this session:', (0.417).toFixed(3), 'NRX');
...
function completeOGAdsTask(type) {
    ...
    // Show success
    showNotification('✅ Task completed! Mining can continue.', 'success');
...
console.log("✅ NRX Mining Platform - VALUE-PRESERVING CONFIG LOADED");
console.log("💰 Daily Limit: 20 NRX | Mining Rate: 0.00139 NRX/sec");
console.log("⚡ 5-min Session: 0.417 NRX | Full Daily: 48 sessions");
